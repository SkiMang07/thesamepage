...
to `homepage-argument.md` — same format, same voice rules.

Sources: `homepage-argument.md`, `docs/build-process.md` (the open item on
...
- **Privacy policy page** doesn't exist yet (`docs/build-process.md` lists
