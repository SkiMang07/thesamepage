...
// Renders under the root layout only, on the light marketing theme. The
// marketing site lives on HubSpot (www.thesamepage.xyz), so "Home page" leaves
// the app rather than hitting / here, which redirects to login.
...
export default function NotFound() {
  return (
    <main className="mx-auto max-w-xl px-6 py-24">
      <a href="https://www.thesamepage.xyz/" className="mb-10 flex items-center gap-2.5">
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <a href="https://www.thesamepage.xyz/" className="rounded-md border border-control px-5 py-3 text-ink">
          Home page
        </a>
      </div>
    </main>
