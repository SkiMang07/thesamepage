...
| 2026-08-23 | `/app/1-1s` (Due now / Upcoming 1:1s / Recently wrapped) is the one front door for the recurring conversation loop. The prep sheet owns its meeting date and 1–4 week repeat control; the front door remains triage, not a second editor | Scheduling is part of preparation, while the overview answers what is due, scheduled, or already in flight without duplicating the write path |
