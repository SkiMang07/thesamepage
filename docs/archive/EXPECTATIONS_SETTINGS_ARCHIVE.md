# Archived: Roles and expectations as a Settings section (superseded 2026-09-26)

Superseded by the Roles & expectations page — current behaviour is `docs/systems/expectations.md`. Kept for history; not current intent.
