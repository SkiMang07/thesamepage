...
`gtm/site/homepage.md` — same format, same voice rules.

Sources: `gtm/site/homepage.md` (locked copy system, founder framing decisions),
...
- **Founder photo.** Still blocked on the same demo-data session noted in
  `website/docs/build-process.md`'s "Then" list. The prototype ships with the same
